...
/**
 * OASE-115 [QA][Phase 5] — mode démo isolé.
 *
 * Les données ci-dessous sont des mocks utilisés pour la maquette /
 * le développement local (`VITE_DEMO_MODE=true` + serveur dev Vite).
 * Elles ne doivent JAMAIS être servies en production : en prod on passe
 * par les vrais endpoints NestJS (cf. services/api.ts).
 *
 * Double garde : `import.meta.env.DEV` garantit qu'un build de production
 * ne peut JAMAIS activer le mode démo, même si un .env.local fuit dans
 * le contexte de build (Docker, CI…). Comme ça, même si une vue oublie
 * d'ajouter son propre `v-if="isDemoMode"`, aucune donnée fictive ne
 * fuit vers la prod.
 */
const RAW = (import.meta.env.VITE_DEMO_MODE ?? '').toString().toLowerCase().trim()
const FLAG_ENABLED =
  RAW === '1' || RAW === 'true' || RAW === 'yes' || RAW === 'on'
export const IS_DEMO_MODE = import.meta.env.DEV && FLAG_ENABLED

function emptyIfProd<T>(arr: T[]): T[] {
  return IS_DEMO_MODE ? arr : []
}

const _mockDemandes: Demande[] = [
  { id: '1', reference: 'OASE-2026-0042', type: 'douaniere', contribuable: 'TOGO STEEL SARL', nif: 'TG-001-2019-B', rccm: 'TG-LOM-2019-B-1234', statut: 'en_cours', dateDepot: '2026-03-15', dateEcheance: '2026-09-15', montantFCFA: 45000000, quotaConsomme: 18000000, quotaTotal: 45000000, etapeActuelle: 'Instruction OTR Douanes', instructeur: 'K. ABALO', secteur: 'Industrie', baseJuridique: 'CGI Art. 215' },
  { id: '2', reference: 'OASE-2026-0039', type: 'fiscale_tva', contribuable: 'AGRO-TOGO INVEST SA', nif: 'TG-002-2020-A', rccm: 'TG-LOM-2020-A-5678', statut: 'approuve', dateDepot: '2026-02-10', dateEcheance: '2027-02-10', montantFCFA: 120000000, etapeActuelle: 'Approuvé — Actif', secteur: 'Agriculture', baseJuridique: 'LFI 2026 Art. 45' },
  { id: '3', reference: 'OASE-2026-0035', type: 'zone_franche', contribuable: 'LOMÉ TEXTILE ZF SAS', nif: 'TG-003-2021-C', rccm: 'TG-LOM-2021-C-9012', statut: 'action_requise', dateDepot: '2026-01-20', montantFCFA: 89000000, etapeActuelle: 'Complément requis — Pièces manquantes', instructeur: 'A. MENSAH', secteur: 'Industrie textile', baseJuridique: 'Code ZFI 2018' },
  { id: '4', reference: 'OASE-2025-0118', type: 'fiscale_is', contribuable: 'MINES DU NORD TOGO', nif: 'TG-004-2018-D', rccm: 'TG-KAR-2018-D-3456', statut: 'rejete', dateDepot: '2025-11-05', montantFCFA: 230000000, etapeActuelle: 'Rejeté — Base juridique invalide', instructeur: 'P. TCHALLA', secteur: 'Mines', baseJuridique: 'Code minier 2012 Art. 78' },
  { id: '5', reference: 'OASE-2025-0098', type: 'code_investissement', contribuable: 'ENERGIE SOLAIRE TOGO', nif: 'TG-005-2022-E', rccm: 'TG-LOM-2022-E-7890', statut: 'approuve', dateDepot: '2025-09-12', dateEcheance: '2026-09-12', montantFCFA: 175000000, etapeActuelle: 'Approuvé — Actif', secteur: 'Énergie', baseJuridique: 'Code des investissements Art. 14' },
  { id: '6', reference: 'OASE-2026-0044', type: 'sectorielle', contribuable: 'NUMERIQUE AFRIQUE SA', nif: 'TG-006-2023-F', rccm: 'TG-LOM-2023-F-2345', statut: 'brouillon', dateDepot: '2026-04-01', montantFCFA: 55000000, etapeActuelle: 'Brouillon — Non soumis', secteur: 'Numérique', baseJuridique: 'LFI 2025 Art. 67' },
  { id: '7', reference: 'OASE-2024-0200', type: 'douaniere', contribuable: 'PORT DE LOMÉ SARL', nif: 'TG-007-2016-G', rccm: 'TG-LOM-2016-G-5432', statut: 'expire', dateDepot: '2024-04-15', dateEcheance: '2025-04-15', montantFCFA: 310000000, etapeActuelle: 'Expiré — Non renouvelé', secteur: 'Transport', baseJuridique: 'CGI Art. 215' },
  { id: '8', reference: 'OASE-2026-0041', type: 'fiscale_tva', contribuable: 'HOPITAL SAINT-LUC ONG', nif: 'TG-008-2017-H', rccm: 'TG-ATK-2017-H-8765', statut: 'en_cours', dateDepot: '2026-03-28', montantFCFA: 28000000, etapeActuelle: 'Visa DGBF en cours', instructeur: 'M. KOFFI', secteur: 'Santé', baseJuridique: 'LFI 2026 Art. 12' },
  { id: '9', reference: 'OASE-2026-0044', type: 'sectorielle', contribuable: 'NUMERIQUE AFRIQUE SA', nif: 'TG-006-2023-F', rccm: 'TG-LOM-2023-F-2345', statut: 'en_cours', dateDepot: '2026-04-01', montantFCFA: 55000000, etapeActuelle: 'Instruction OTR Impôts', instructeur: 'A. MENSAH', secteur: 'Numérique', baseJuridique: 'LFI 2025 Art. 67' },
  { id: '10', reference: 'OASE-2026-0045', type: 'code_investissement', contribuable: 'LOGISTIQUE TOGO SA', nif: 'TG-010-2019-J', rccm: 'TG-LOM-2019-J-1122', statut: 'approuve', dateDepot: '2026-01-10', dateEcheance: '2028-01-10', montantFCFA: 195000000, etapeActuelle: 'Approuvé — Actif', secteur: 'Transport', baseJuridique: "Code des investissements Art. 22" },
  { id: '11', reference: 'OASE-2025-0150', type: 'zone_franche', contribuable: 'PHARMA WEST AFRICA ZF', nif: 'TG-011-2020-K', rccm: 'TG-LOM-2020-K-3344', statut: 'en_cours', dateDepot: '2026-02-14', montantFCFA: 140000000, etapeActuelle: 'Instruction OTR Douanes', instructeur: 'K. ABALO', secteur: 'Pharmaceutique', baseJuridique: 'Code ZFI 2018 Art. 5' },
  { id: '12', reference: 'OASE-2026-0047', type: 'fiscale_is', contribuable: 'COOPEC NORD TOGO', nif: 'TG-012-2015-L', rccm: 'TG-KAR-2015-L-5566', statut: 'action_requise', dateDepot: '2026-03-05', montantFCFA: 18000000, etapeActuelle: 'Complément requis — Bilan 2025 manquant', instructeur: 'P. TCHALLA', secteur: 'Finance', baseJuridique: 'CGI Art. 110' },
]
export const mockDemandes = emptyIfProd(_mockDemandes)

const _mockConnecteurs: Connecteur[] = [
...
export const mockConnecteurs = emptyIfProd(_mockConnecteurs)

const _mockUtilisateurs: Utilisateur[] = [
  ...
  { id: '8', nom: 'NYAVOR', prenom: 'Edem', email: 'e.nyavor@steeltogo.tg', role: 'contribuable', structure: 'TOGO STEEL SARL', statut: 'actif', derniereConnexion: '2026-04-26T16:10:00' },
  ...
  { id: '12', nom: 'AMEGA', prenom: 'Kodjo', email: 'k.amega@numerique-afrique.tg', role: 'contribuable', structure: 'NUMERIQUE AFRIQUE SA', statut: 'actif', derniereConnexion: '2026-04-27T09:45:00' },
]
export const mockUtilisateurs = emptyIfProd(_mockUtilisateurs)

const _mockAnomalies: Anomalie[] = [
  ...
  { id: 'A005', categorie: 'juridique', gravite: 'elevee', description: 'Contribuable avec dettes fiscales déclarées dans SIGTAS (IS 2024)', dossier: 'OASE-2026-0038', dateDetection: '2026-04-24', statut: 'nouvelle' },
  { id: 'A006', categorie: 'financiere', gravite: 'critique', description: 'Doublon détecté : même contribuable, même base juridique dans SYDONIA et SIGTAS', dossier: 'OASE-2025-0099', dateDetection: '2026-04-25', statut: 'nouvelle' },
]
export const mockAnomalies = emptyIfProd(_mockAnomalies)

const _mockConventions: Convention[] = [
  { id: 'C001', reference: 'ZFI-2024-012', contribuable: 'LOMÉ TEXTILE ZF SAS', regime: 'Zone Franche Industrielle', statut: 'active', dateDebut: '2024-01-15', dateFin: '2034-01-15', montantEstime: 890000000, emploisEngages: 450, emploisCrees: 312 },
  { id: 'C002', reference: 'ZES-2023-008', contribuable: 'AGRO-PROCESSING ZES', regime: 'Zone Économique Spéciale', statut: 'active', dateDebut: '2023-06-01', dateFin: '2033-06-01', montantEstime: 1200000000, emploisEngages: 800, emploisCrees: 620 },
  { id: 'C003', reference: 'CI-2025-003', contribuable: 'ENERGIE SOLAIRE TOGO', regime: 'Code des investissements', statut: 'active', dateDebut: '2025-03-10', dateFin: '2030-03-10', montantEstime: 560000000, emploisEngages: 180, emploisCrees: 95 },
  { id: 'C004', reference: 'ZFI-2020-005', contribuable: 'TOGO PHARMA ZF', regime: 'Zone Franche Industrielle', statut: 'suspendue', dateDebut: '2020-09-01', dateFin: '2030-09-01', montantEstime: 420000000, emploisEngages: 200, emploisCrees: 87 },
  { id: 'C005', reference: 'CI-2026-004', contribuable: 'LOGISTIQUE TOGO SA', regime: "Code des investissements", statut: 'active', dateDebut: '2026-01-10', dateFin: '2031-01-10', montantEstime: 310000000, emploisEngages: 120, emploisCrees: 38 },
  { id: 'C006', reference: 'ZES-2025-009', contribuable: 'PHARMA WEST AFRICA ZF', regime: 'Zone Économique Spéciale', statut: 'active', dateDebut: '2025-07-01', dateFin: '2035-07-01', montantEstime: 780000000, emploisEngages: 350, emploisCrees: 180 },
]
export const mockConventions = emptyIfProd(_mockConventions)

const _mockAuditLogs: AuditLog[] = [
...
export const mockAuditLogs = emptyIfProd(_mockAuditLogs)

const _mockKpisDashboardDecideur: KpiData[] = [
...
export const mockKpisDashboardDecideur = emptyIfProd(_mockKpisDashboardDecideur)

const _mockEvolutionMensuelle = [
...
export const mockEvolutionMensuelle = emptyIfProd(_mockEvolutionMensuelle)

const _mockTopSecteurs = [
...
export const mockTopSecteurs = emptyIfProd(_mockTopSecteurs)
...
export const mockNotifications = emptyIfProd(_mockNotifications)
...
export const mockRegions = emptyIfProd(_mockRegions)
